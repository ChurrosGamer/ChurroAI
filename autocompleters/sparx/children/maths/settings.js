const { ButtonBuilder, ButtonStyle, ActionRowBuilder, MessageFlags, ContainerBuilder, StringSelectMenuBuilder, LabelBuilder, TextDisplayBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, SeparatorBuilder, SeparatorSpacingSize } = require('discord.js');
        ...
        if (componentInteraction.isButton()) {
            if (componentInteraction.customId === 'fake_time') {
				const modal = new ModalBuilder()
					.setCustomId(`autocompleterModule_sparx(maths)_faketime_settings`)
				...
				const modal = new ModalBuilder()
					.setCustomId(`autocompleterModule_sparx(maths)_pdf_settings`)
				...
				const modal = new ModalBuilder()
					.setCustomId(`autocompleterModule_sparx(maths)_model_settings`)
